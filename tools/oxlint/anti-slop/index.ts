...
import { requireSyncCommentForUseEffectRule } from "./rules/require-sync-comment-for-use-effect.ts";
...
const antiSlopPlugin = eslintCompatPlugin({
	...
	rules: {
		...
		"require-sync-comment-for-use-effect": requireSyncCommentForUseEffectRule,
	},
});
